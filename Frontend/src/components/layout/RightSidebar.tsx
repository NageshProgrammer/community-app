...
export function RightSidebar() {
  ...
  return (
    <aside className="hidden lg:block w-80 p-4 h-screen sticky top-0 overflow-y-auto hide-scrollbar">
      ...
      {/* Search Bar */}
      <div className="sticky top-0 bg-transparent pb-4 z-10 pt-2 backdrop-blur-md">
        <div 
      ...
      <div className="flex flex-col gap-4 text-white">
        ...
        <div className="bg-gray-900 rounded-2xl p-4 border border-gray-800">
          ...
          <div className="flex flex-col gap-4">
            <div onClick={() => setSearchQuery('#ReactJS')} className="hover:bg-gray-800 -mx-4 px-4 py-2 cursor-pointer transition-colors">
            ...
            <div onClick={() => setSearchQuery('Tailwind V4')} className="hover:bg-gray-800 -mx-4 px-4 py-2 cursor-pointer transition-colors">
            ...
            <div onClick={() => setSearchQuery('Framer Motion')} className="hover:bg-gray-800 -mx-4 px-4 py-2 cursor-pointer transition-colors">
              ...
              return (
                <div key={user.id} className="flex items-center justify-between">
                  ...
                  <motion.button
                    ...
                    className={`font-bold text-sm py-1.5 px-4 rounded-full flex-shrink-0 transition-all ${
                      isFollowing 
                        ? 'bg-transparent border border-gray-800 text-white hover:border-red-500 hover:text-red-500 hover:bg-red-500/10 group/btn' 
